(function UMDish(name, context, definition) {  context[name] = definition.call(context);  if (typeof module !== "undefined" && module.exports) {    module.exports = context[name];  } else if (typeof define == "function" && define.amd) {    define(function reference() { return context[name]; });  }})("OFRealtimeEngine", this, function OFRealtimeEngine() {/*globals require, define */
'use strict';
 ...
 *
 * @param {OFRealtimeEngine} self The context of the function.
...
function OFRealtimeEngine(url, options) {
  ...
  primus.readyState = OFRealtimeEngine.CLOSED;            // The readyState of the connection.
 ...
 * @private
 */
OFRealtimeEngine.OPENING = 1;   // We're opening the connection.
OFRealtimeEngine.CLOSED  = 2;   // No active connection.
OFRealtimeEngine.OPEN    = 3;   // The connection is open.
...
try {
  if (
       OFRealtimeEngine.prototype.NETWORK_EVENTS = 'onLine' in navigator
...
/**
 * Checks if the given event is an emitted event by OFRealtimeEngine.
 *
 ...
 * spark.js.
 *
 * @param {OFRealtimeEngine} primus Reference to the Primus instance with message transformers.
 * @param {Spark|OFRealtimeEngine} connection Connection that receives or sends data.
...
// server-side using the OFRealtimeEngine#library method.
//
...
OFRealtimeEngine.prototype.version = "2.4.6";
...
if (
 ...
 return OFRealtimeEngine; });(function OFRealtimeEngineLibraryWrap(OFRealtimeEngine) {(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
